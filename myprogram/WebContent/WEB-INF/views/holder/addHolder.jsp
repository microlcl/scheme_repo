...
<head>
	...
	function add() {
		...
		td1.append('	        会场名称：<input type="text" id="spaces['+row_count+'].space_name" name="spaces['+row_count+'].space_name" class="input-medium required" maxlength="32" />');
		td2.append('	       会场所在楼层：<input type="text" id="spaces['+row_count+'].floor" name="spaces['+row_count+'].floor"  class="input-small" maxlength="3" onkeyup="clearNoNum(this)"/>');
		td3.append('		容纳人数：<input type="text" id="spaces['+row_count+'].volume" name="spaces['+row_count+'].volume" class="input-small" maxlength="5" onkeyup="clearNoNum(this)"/>');
		td4.append('		楼层空间高度：<input type="text" id="spaces['+row_count+'].hall_height" name="spaces['+row_count+'].hall_height" class="input-small" maxlength="2" onkeyup="clearNoNum(this)"/>');
		
		td5.append('&nbsp;		 ');
		td6.append('		&nbsp;舞&nbsp;台&nbsp;长：&nbsp;<input type="text" id="spaces['+row_count+'].stage_length" name="spaces['+row_count+'].stage_length" class="input-small" maxlength="5" onkeyup="clearNoNum(this)"/>');
		td7.append('		舞台宽：<input type="text" id="spaces['+row_count+'].stage_width" name="spaces['+row_count+'].stage_width" class="input-small" maxlength="5" onkeyup="clearNoNum(this)"/>');
		td8.append('		舞台高：<input type="text" id="spaces['+row_count+'].stage_height" name="spaces['+row_count+'].stage_height" class="input-small" maxlength="2" onkeyup="clearNoNum(this)"/>');
		td9.append('		&nbsp;');
