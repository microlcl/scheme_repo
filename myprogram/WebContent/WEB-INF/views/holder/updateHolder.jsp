	...
	<form id="holderForm" action="${ctx}/holder/save" method="post" class="form-horizontal" class="form-inline">
		<div class="form">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea  id="description" name="description"  class="input-large" maxlength="64"/>${holder.description}</textarea>
				</div>
			</div>
			<div class="control-group">
			...
			<tr>
				<td>
					<c:forEach items="${holder.spaces}" var="space">
						<table>
							<tr>
								...
								<td>
									会场名称：<input type="text"  name="spaces['+row_count+'].space_name" value="${space.space_name}" class="input-large required" maxlength="32" />
								</td>
								<td align='right'>
									会场所在楼层：<input type="text"  name="spaces['+row_count+'].floor" value="${space.floor}" class="input-small" maxlength="3" onkeyup="clearNoNum(this)"/>
								</td>
								<td align='right'>
									容纳人数：<input type="text"  name="spaces['+row_count+'].volume" value="${space.volume}" class="input-small" maxlength="5" onkeyup="clearNoNum(this)"/>
								</td>
								<td align='right'>
									楼层空间高度：<input type="text" id="hall_height " name="spaces['+row_count+'].hall_height" value="${space.hall_height}" class="input-small" maxlength="2" onkeyup="clearNoNum(this)"/>
								</td>
							</tr>
							<tr>
								<td align='center' width='100'>
								...
								<td>
									&nbsp;舞&nbsp;台&nbsp;长：&nbsp;<input type="text"  name="spaces['+row_count+'].stage_length" value="${space.stage_length}" class="input-small" maxlength="5" onkeyup="clearNoNum(this)"/>
								</td>
								<td align='right'>
									舞台宽：<input type="text"  name="spaces['+row_count+'].stage_width" value="${space.stage_width}" class="input-small" maxlength="5" onkeyup="clearNoNum(this)"/>
								</td>
								<td align='right'>
									舞台高：<input type="text"  name="spaces['+row_count+'].stage_height" value="${space.stage_height}" class="input-small" maxlength="2" onkeyup="clearNoNum(this)"/>
								</td>
								<td align='right'>
									舞台性质：<input type="text" name="spaces['+row_count+'].attribute_id" value="${space.attribute_id}" class="input-small" maxlength="10" onkeyup="clearNoNum(this)"/>
								</td>
							</tr>
							<tr>
								<td align='center' width='100'>
								...
								<td>
									&nbsp;&nbsp;描&nbsp;&nbsp;述&nbsp;：&nbsp;&nbsp;<textarea  name="spaces['+row_count+'].description" class="input-large" maxlength="64" >${space.description}</textarea>
								</td>
							</tr>
						</table>
					</c:forEach>
