...
<head>
	...
	<script>
		...
		$(document).ready(function() {
			...
			var businessTypeId = ['${procedures.businessType.id}'];
			$("#cc2").combotree({ 
...
<body>
	<div class="form">
		...
		<div style="padding:20px;">
			<form id="procedureForm" action="${ctx}/procedure/update" method="post">
				<input id="paper_id" value="${procedures.id}" type="hidden" name="id"/>
				...
				<input type="text" name="name"  maxlength="64" class="span3 required" placeholder="0~64个字符" style="margin-right:100px;" value="${procedures.name}"/><br>
