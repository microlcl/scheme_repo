		...
		<div class="row">
			...
			<div class="span2">
				...
				<td>subscribers &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" data-toggle="modal" onclick="userPopupWindow({callback:addUser})">Add...</a></td>
				 	...
				 	<c:forEach items="${task.subUsers}" var="user">
					<tr class="success">
						<td>${user.id}<input type="hidden" name="subUsers" value="${user.id}"><a href="javascript:void(0);" onclick="deleteOption(this)" title="删除">
