...
create table questionnair (
	...
	case_type varchar(16), -- 庆典种类
	question varchar(64),
	question_type varchar(64), -- 问题种类：单选，多选，开放式问题等 ,可以在category table里面配置
	question_options varchar(256), -- 问题答案选项，用特殊字符^分隔， 如果是开放式问题， 此字段为空
	primary key (question_id)
);

create table cases_answers (
	case_id bigint,
	question_id bigint,
...
-- case中的主角
create table case_main_character (
	case_id bigint,
	main_character_id bigint,   -- customer id
	main_character_title varchar(16), -- 庆典主角title，比如新娘，新郎等
